...
const experiences = [
  ...
  },
  {
    ...
    company: "Freshly",
    period: "Present",
    description: "Contributing to community management in one of the larger Roblox groups with 394K members",
    skills: ["Corporate Operations", "Team Collaboration", "Community Support"],
  },
]
